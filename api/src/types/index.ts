...
// Token summary pushed to UI/alerts
...
// Security report from SecAuditor
...
// CEX-listing event from Sentinel
...
export interface RadarConfig {
  ...
  radarOnly: boolean;
  enablePortfolioSim: boolean;
  enableTradeActions: boolean;
  enableWalletIntegrations: boolean;
}
